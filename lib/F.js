 ...
 */
F.EachIterator = function(iterator, func) {
  this._iter = iterator;
  this._func = func;
};

F.EachIterator.prototype.next = function() {
  var value = this._iter.next();
 ...
 * the iterable.
 */
F.Iterable.prototype.each = function(func) {
  return F(new F.EachIterator(this._iter, func));
};
